...
const PanelSection = ({ title, children, actionIcons = [] }) => {
  ...
  return (
    <>
      <div
        className="bg-main mt-[2px] flex h-7 cursor-pointer select-none items-center justify-between rounded-[4px] pl-2.5 text-[13px]"
      ...
      {areChildrenVisible && (
        <>
          ...
          <div className="bg-main-light rounded-b-[4px]">{children}</div>
        </>
      )}
    </>
  );
