...
const Modal = ({
  ...
  const renderHeader = () => {
    return (
      title && (
        <header className="bg-main-light flex items-center rounded-tl rounded-tr px-[20px] py-[13px]">
          <Typography
            variant="h6"
            color="primaryLight"
  ...
  return (
    ...
    >
      {renderHeader()}
      <section className="ohif-scrollbar modal-content bg-main-light overflow-y-auto rounded-bl rounded-br px-[20px] pt-2 pb-[20px]">
        {children}
      </section>
    </ReactModal>
  );
