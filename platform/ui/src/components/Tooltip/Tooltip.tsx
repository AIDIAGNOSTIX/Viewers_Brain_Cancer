      ...
      >
        <div
          className={classnames(
            'tooltip-box bg-main_light border-secondary-light w-max-content relative inset-x-auto top-full rounded border text-base text-white',
            {
              'py-1 px-4': !tight,
            }
          )}
        >
          ...
          <svg
            className="text-main_light stroke-secondary-light absolute h-4"
