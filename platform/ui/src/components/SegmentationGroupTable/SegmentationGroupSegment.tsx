...
const SegmentItem = ({
  ...
  return (
    ...
    >
      <div
        className={classnames('bg-main-light group/number grid w-[32px] place-items-center', {
          'bg-primary-light border-primary-light rounded-l-[4px] border text-black': isActive,
          'border-main-light border': !isActive,
        })}
      ...
      <div
        className={classnames('relative flex w-full', {
          'border-primary-light bg-main-light rounded-r-[4px] border border-l-0': isActive,
          'border border-l-0 border-transparent': !isActive,
        })}
      >
        <div className="group-hover/row:bg-main-light flex h-full w-full flex-grow items-center">
